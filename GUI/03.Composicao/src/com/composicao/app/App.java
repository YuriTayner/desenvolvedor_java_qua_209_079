...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        String[] opcoes = {
            "Exibir dados da conta", "Fazer depósito", "Fazer saque", "Sair"
        };
        ...
        do{
            opcao = JOptionPane.showInputDialog(null, "Escolha a operação desejada:", "Java Bank", JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]); 
